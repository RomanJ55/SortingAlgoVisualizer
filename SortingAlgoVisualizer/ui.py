from tkinter import Tk, Frame, Button, Canvas, BOTH, TOP, LEFT
import time
...
class Sort_UI(Frame):
    ...
    def __initialize(self):
        ...
        self.generate_button = Button(
            self, text="Generate Array", command=lambda: [self.sorting.populate_board(), self.draw_board(self.sorting.board), self.canvas.delete("times")])
    ...
    def merge_sort(self, array, l, r):
        ...
        self.canvas.create_text(
            90, 30, text="Time: O(nlog(n))", font="arial 14", tag="times")
    ...
    def bubble_sort(self, array):
        ...
        for i in range(len(array)-1):
            for j in range(len(array)-i-1):
                ...
                self.draw_board(self.sorting.board)
        self.canvas.create_text(
            90, 30, text="Time: O(n^2)", font="arial 14", tag="times")
